...
(define (search-read result)
    (string-append "{found:"
        (b-read (head result))
        ",index:"
        (number->string (n-read (tail result)))
        "}"))
(display "[1,2,4,5,125]: ")
(display (l-read l_1_2_4_5_125 n-read))
(newline)
(display "l_1_2_4_5_125 ind of 1: ")
(display (search-read ((binarySearch l_1_2_4_5_125) one)))
(newline)
(display "l_1_2_4_5_125 ind of 2: ")
(display (search-read ((binarySearch l_1_2_4_5_125) two)))
(newline)
(display "l_1_2_4_5_125 ind of 4: ")
(display (search-read ((binarySearch l_1_2_4_5_125) four)))
(newline)
(display "l_1_2_4_5_125 ind of 5: ")
(display (search-read ((binarySearch l_1_2_4_5_125) five)))
(newline)
(display "l_1_2_4_5_125 ind of 125: ")
(display (search-read ((binarySearch l_1_2_4_5_125) one-twenty-five)))
(newline)
(display "l_1_2_4_5_125 ind of 3: ")
(display (search-read ((binarySearch l_1_2_4_5_125) three)))
(newline)
