...
(define FOLD-tests (list
    ...
    (test-list-element "FOLD(EXP)(2)(LIST-1-3)" (read-any (((FOLD EXP) TWO) ((_make-list nat) (_cons one three)))) "nat:8")
    ; error cases
    (test-list-element "FOLD(EXP)(posONE)(LIST-2-3)" (read-any (((FOLD EXP) posONE) ((_make-list nat) (_cons two three)))) "FOLD(EXP(arg1(err:nat))->EXP(arg1(err:nat)))")
    (test-list-element "FOLD(EXP)(ONE)(LIST-p2-p3)" (read-any (((FOLD EXP) ONE) ((_make-list int) (_cons posTwo posThree)))) "FOLD(EXP(arg2(err:nat))->EXP(arg1(err:nat)))")
    (test-list-element "FOLD(EXP)(ONE)(FALSE)" (read-any (((FOLD EXP) ONE) FALSE)) "FOLD(arg3(err:list))")
))
